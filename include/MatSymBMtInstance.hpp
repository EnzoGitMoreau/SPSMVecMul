                ...
                if(m!=0)
                    {
                        if(dist>=0)//Cas de base, on itre sur x
                        {
                            if(!change)
                                ...
                                else//Je change Y2 et X1, j'applique donc les rŽsultats des calculs prŽcendents
                                {
                                    Y2_[0] += y20;
                                    Y2_[1] += y21;
                                    Y2_[2] += y22;
                        ...
                        {
                            if(!change)//Je change Y2 et X1, j'applique donc les rŽsultats des calculs prŽcendents
                                {}
                                else
                                {
                                    Y2_[0] += y20;
